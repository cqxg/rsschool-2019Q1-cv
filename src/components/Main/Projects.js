...
Github
      ...
      <p>
Link:
        <a className="project_link" href="https://cqxg-chat.netlify.com/">cqxg-chat.netlify.com</a>
      </p>
...
Link:
        <a
          ...
          href="https://cqxg.github.io/animation-editor/"
        >
cqxg.github.io/animation-editor
        </a>
      </p>
      <p>
The goal of the project is to create an application that will include tools for drawing, animation
                    then and creating .gif or .png images for download.
      </p>
      <div className="env_wrap">
        <p className="highlight">Environment:</p>
...
Link:
        ...
        >
belarusian-directors.netlify.com
        </a>
      </p>
      ...
      <p>
Link:
        <a className="project_link" href="https://cqxg.github.io/search/">cqxg.github.io/search</a>
      </p>
