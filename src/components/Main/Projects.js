    ...
    return (
        <div id="content_container">
            ...
            <div className="last block">
                ...
                <a href="https://dot818.com/plat/" target='_blank' rel='noopener noreferrer'><img  className='border' src={Plat} alt="chat" /></a>
                <p>{t('platDesc')}</p>
                <p>{t('platMoreDesc')}</p>
                ...
                <a href="https://cqxg-chat.netlify.com/" target='_blank' rel='noopener noreferrer'><img className='border' src={Chat} alt="chat" /></a>
                <p>{t('chatDesc')}</p>
                ...
                <a href="https://cqxg.github.io/animation-app/dist/" target='_blank' rel='noopener noreferrer'><img className='border' src={Editor} alt="editor" /></a>
                <p>{t('editorDesc')}</p>
                ...
                <a href="https://belarusian-directors.netlify.com/" target='_blank' rel='noopener noreferrer'><img className='border' src={Culture} alt="culture" /></a>
                <p>{t('cultureDesc')}</p>
                ...
                <a href="https://cqxg.github.io/Work_with_arrays/" target='_blank' rel='noopener noreferrer'><img className='border' src={ArrOfArr} alt="arrays" /></a>
                <p>{t('arrDesc')}</p>
