    ...
    return (
        <div id="content_container">
            <div className="block">
                ...
                <p>{t('university')}
                    <a className="education_link" target='_blank' href="http://bseu.by/english/">{' '}{t('uniLocate')}</a>
                , 2014-2018</p>
                <p>{t('special')}</p>
                ...
                <p>{t('rss')}<a className="education_link" target='_blank' href="https://school.rollingscopes.com/">
                ...
                <p>({t('linkedInMore')} <a className="education_link" target='_blank' href="https://www.linkedin.com/in/ihar-ivaniuk/">
                    {t('linkedInLink')}</a>)</p>
